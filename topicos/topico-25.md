...
1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2021-1-bxx, cujo título é "Tópico 25", para indicar suas reflexões iniciais sobre *decisões de projeto no Modelo Entidade Relacionamento (MER)*.
