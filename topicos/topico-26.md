## [Tópico T26] - Modelo Entidade Relacionamento (MER) - Generalização/Especialização
...
Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-1-bxx, com o título "Tópico 26", para responder: 

1. Há duas hierarquias do tipo generalização/especialização? (Responda Sim ou Não) Não
1. É possível inserir um funcionário cujo cargo não é _secretária_, _técnico_ e _engenheiro_ (por exemplo, _médico_)? (Responda Sim ou Não) Sim
1. Todo funcionário é secretária, técnico ou engenheiro? (Responda Sim ou Não) Não
1. Um funcionário horista pode ser gerente de projeto? (Responda Sim ou Não) Sim
1. Uma secretária pode ser gerente de projeto de projeto? (Responda Sim ou Não) Sim
1. Um engenheiro pode ser horista? (Responda Sim ou Não) Sim
1. TECNICO e ENGENHEIRO representam dois subconjuntos disjuntos? (Responda Sim ou Não) Sim
1. ENGENHEIRO e GERENTE representam dois subconjuntos disjuntos? (Responda Sim ou Não) Não

## Artefatos

1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2021-1-bxx, cujo título é "Tópico 26", para indicar suas reflexões iniciais sobre *generalização/especialização no Modelo Entidade Relacionamento (MER)*.
